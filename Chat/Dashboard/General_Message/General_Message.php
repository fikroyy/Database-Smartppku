...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            <li><a href="../Main_Dashboard.php"><img src="../img/dashboard.png" class="navimg img-responsive"/><span class="nav-writting">Materi</span></a></li>
            <li><a style="border-left:4px solid rgba(69, 162, 255, 0.93); border-radius:10px" href="General_Message.php"><img src="../img/chat-1.png" class="navimg img-responsive" /><span class="nav-writting">Chat Umum</span></a></li>
            ...
            <li><a href="../General_Share/General_Share.php"><img src="../img/remove-user.png" class="navimg img-responsive" /><span class="nav-writting">Privasi</span></a></li>
    ...
    <!-- Main Content Starts Here -->
      ...
      <div id="Main_Chat_Box" class="col-md-8">
        ...
        <div id="get_chatting_user_name">
          <div style="font-weight:bold;font-size:1.2em;float:left;color:rgba(69, 162, 255, 0.93)">Chat Umum</div>
      ...
      <div id="Right_side_bar" class="col-md-3">
        ...
        <div><span class="right_side_logo"> Hari Ini <hr></span>
