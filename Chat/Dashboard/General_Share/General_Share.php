...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            <li><a style="border-left:4px solid rgba(69, 162, 255, 0.93); border-radius:10px" href="General_Share.php"><img src="../img/businessman.png" class="navimg img-responsive" /><span class="nav-writting">Berbagi</span></a></li>
   ...
   <div class="main_content">
      ...
      <div class = "panel panel-adjusted">
       <div class = "panel-heading phead">
        <h2 class = "panel-title ptitle">Berbagi</h2>
       </div>
      ...
      <ul>
        <!-- The file uploads will be shown here -->
         ...
         <div class="side_bar_holder">
          <div class="designer">
           <div style="text-align:center;padding-top:15px"><span style="color:white;font-weight:bold">Uploads<span></div>
          </div>
