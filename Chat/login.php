...
<body>
  ...
  <input class='lf--submit' type='submit' value='Masuk' name="submit" id="btnSubmit">

	  <p style="font-size:.7em;color:#2dc6bf;text-align:center;cursor:hand"><u><a style="color:#2dc6bf" href="users_signup.php">Daftar</a></u></p>
